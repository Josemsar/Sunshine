...
/**
 * Created by JoseMiguel on 17/03/2015.
 */
public class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //Toast toast = Toast.makeText(getActivity().getApplicationContext(), mForecastAdapter.getItem(i), Toast.LENGTH_LONG);
                //toast.show();
            }
        });
    ...
    public void updateWeather() {
        ...
        myFetchWeatherTask.execute(PreferenceManager.getDefaultSharedPreferences(getActivity()).getString(getString(R.string.pref_location_key), getString(R.string.pref_location_default)));
    }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                forecast = getWeatherDataFromJson(forecastJsonStr, days);
                return forecast;
